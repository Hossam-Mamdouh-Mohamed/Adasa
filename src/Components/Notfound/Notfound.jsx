...
export default function Notfound() {
  return (
    <main className="pt-20">
      <div className="min-h-100vh flex items-center justify-center relative overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="relative text-center px-4 max-w-lg mx-auto">
          <div className="relative mb-6">
            <h1 className="text-[140px] md:text-[180px] font-black text-transparent bg-clip-text bg-linear-to-r from-orange-500 via-yellow-500 to-orange-500 leading-none select-none">404</h1>
            <div className="absolute inset-0 text-[140px] md:text-[180px] font-black text-orange-500/20 blur-2xl leading-none select-none pointer-events-none">404</div>
          </div>
          <div className="relative w-28 h-28 mx-auto mb-8">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <svg className="w-14 h-14 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <a className="btn-primary inline-flex items-center justify-center gap-2" href="/" data-discover="true">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>الذهاب للرئيسية</a>
            <a className="btn-secondary inline-flex items-center justify-center gap-2" href="/blog" data-discover="true"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>تصفح المقالات</a>
          </div>
          <div className="pt-8 border-t border-[#262626]">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              ...
              <span className="text-neutral-600">•</span>
              <a className="text-orange-500 hover:text-orange-400 hover:underline font-medium" href="/privacy" data-discover="true">الخصوصية</a>
            </div>
          </div>
        </div>
      </div>
